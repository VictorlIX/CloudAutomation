...
past30 = Wiql(query="SELECT [Changed Date] FROM workitems WHERE [Changed Date] >= @StartOfDay-25 OR [System.State] = 'Active'  " )
    ...
    if date.today().weekday() < 5:
            def send_email(subject, msg):
                try:
                    ...
                    server.sendmail("email@gmail.com","victor_sjv@hotmail.com", message)    
                    server.quit()
