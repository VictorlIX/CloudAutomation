...
# get token: https://dev.azure.com/companyname/gettoken
# CHANGE*
...
past30 = Wiql(query="SELECT [Changed Date] FROM workitems WHERE [Changed Date] >= @StartOfDay-35 OR [System.State] = 'Active'  " )
    ...
    if date.today().weekday() < 5:
            def send_email(subject, msg):
                try:
                    ...
                    server.sendmail("email@gmail.com", emails, message)    
                    server.quit()
